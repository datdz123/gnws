 ...
 * @return array
 */
function iheal_body_classes( $classes ) {
...
add_filter( 'body_class', 'iheal_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function iheal_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'iheal_pingback_header' );
...
if ( ! function_exists( 'iheal_post_thumbnail' ) ) :
	/**
	 * Returns the post thumbnail URL or a placeholder URL if not available.
	 */
	function iheal_post_thumbnail() {
...
if ( ! function_exists( 'iheal_post_thumbnail_full' ) ) :
	/**
	 ...
	 */
	function iheal_post_thumbnail_full() {
		if ( post_password_required() || is_attachment() || ! has_post_thumbnail() ) {
			return get_stylesheet_directory_uri() . '/assets/svg/placeholder.svg';
		} else {
...
function iheal_pagination() {
	...
	echo '<div class="iheal-pagination"><ul>' . "\n";
