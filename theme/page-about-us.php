...
<main class="bg-[#f3eee2] font-body text-[#10241a]">
	<section class="">
		<div class="bg-white">
			<section class="grid gap-10 px-6 py-16 md:px-12 lg:grid-cols-[0.95fr_1.05fr] lg:px-16 lg:py-20">
			...
			<section class="bg-[#edf7ee] px-6 py-16 md:px-12 lg:px-16 lg:py-20">
			...
			<section class="px-6 py-16 md:px-12 lg:px-16 lg:py-20">
