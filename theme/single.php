...
<?php $iheal_single_hero_image = 'https://www.figma.com/api/mcp/asset/9d166b6b-4ebd-41f6-b070-ea4cfb452608'; ?>
	...
	<main class="bg-[#f3eee2] font-body text-[#10241a]">
		<section class="">
			<div class="bg-white">
				<section class="grid gap-10 px-6 py-16 md:px-12 lg:grid-cols-[0.82fr_1.18fr] lg:px-16 lg:py-20">
				...
				<section class="grid gap-10 px-6 pb-20 md:px-12 lg:grid-cols-[minmax(0,760px)_280px] lg:px-16 lg:pb-24">
